      ...
      <section className="flex flex-col sm:flex-row  gap-6">
        <section className="flex-grow-[3] ">
          {cartItem.map((item) => {
            return (
              <div
                className="flex  flex-1 gap-16 p-4 rounded-lg shadow-lg my-12"
                key={item._id}
              >
                <section className="flex gap-6  flex-1">
                  ...
                  />
                  <p className="text-md flex-1 underline font-bold text-slate-500">
                    {item.name}
                  </p>
                  <p className="text-md ml-6  font-bold text-slate-500">
                    ${item.price}
                  </p>
                </section>
                <section>
